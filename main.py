...
エンドポイント:
    POST /monthly-patch : 月次パッチ統合ランナー（URLチェック + JustWatch検索）
    GET  /health        : ヘルスチェック

レスポンス（POST /monthly-patch）:
    {
        "batch": 0,
        "cycle": "2026-05",
...
from monthly_patch import BATCH_COUNT, DEFAULT_BATCH_SIZE
