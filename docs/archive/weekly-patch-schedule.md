...
│ （詳細フォーマットは docs/archive/weekly-patch-notifications.md 参照）    │
└──────────────────────────────────────────────────────────────┘
```
...
docs/archive/weekly-patch-schedule.md      # 本ドキュメント
docs/archive/weekly-patch-notifications.md # Slack 通知フォーマットの詳細
```
